...
export interface RoyaltieContract {
    ...
    swapinNFT(signer: algosdk.Account, assetID: number): Promise<SignedTransaction[]>
    ...
    rescind(signer: algosdk.Account, assetToRescindID: number): Promise<SignedTransaction[]>
