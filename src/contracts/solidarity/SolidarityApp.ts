...
export class SolidarityApp extends BaseContract implements SolidarityContract {
  ...
  async makeInitiateApplicationTransaction(
    signer: TransactionSigner,
    senderAddress: string
  ...
  async makeAddSolidarityForUserTransaction(
    ...
    this.atomicTransactionComposer.addMethodCall({
      ...
      sender: senderAddress,
      methodArgs: [taxPaymentTransaction, solidaritySenderAddress, appName],
      suggestedParams: suggestedParams,
      signer: signer,
    });
  ...
  async makeChangeIndividualSolidarityTransaction(
    ...
    this.atomicTransactionComposer.addMethodCall({
      ...
      sender: senderAddress,
      methodArgs: [userAccount, basisPoints],
      suggestedParams: suggestedParams,
      signer: signer,
    });
  ...
  async makeGetOfferCountTransaction(
    signer: TransactionSigner,
    senderAddress: string,
    userAccount: string
  ): Promise<AtomicTransactionComposer> {
  ...
  async makeRaiseCollectionCountTransaction(
    signer: TransactionSigner,
    senderAddress: string,
  ...
  async makeRaiseOfferCountTransaction(
    signer: TransactionSigner,
    senderAddress: string,
    userAccount: string
  ): Promise<AtomicTransactionComposer> {
